...
function ReadPostPage() {
  ...
  useEffect(() => {
    (async () => {
      const list = await fetchPosts(boardName);
      const found = list.find((p) => String(p.id) === postId);
      setPost(found);
    })();
  }, [boardName, postId]);
  ...
  // const filteredPosts = boards.filter((post) => post.board && post.board.toLowerCase() === boardName.toLowerCase());
      ...
      <div className="container-white">
        ...
        <div className="main-container">
          ...
          <div className="board-container">
            <div className="board-container_contents">
              <div className="read_container">
                ...
                <div className="button_container">
                  <button className="update_button" onClick={() => navigate(`/board/${boardName}/post/${postId}/edit`)}>
                    수정
                  </button>
